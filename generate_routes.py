...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .cta {{ display: inline-flex; align-items: center; gap: 0.5rem; margin-top: 2rem; padding: 0.6rem 1.25rem; background: var(--accent); color: white; border-radius: 0.5rem; text-decoration: none; font-weight: 600; font-size: 0.85rem; }}
...
<body>
    <header>
        <div class="container header-inner">
            ...
            <nav id="nav">
                <button class="close-btn" style="display:none" onclick="toggleMenu()" aria-label="Close">
    ...
    <div class="container">
        ...
        <div class="grid">
            ...
            <div class="card">
                <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 22V5a2 2 0 012-2h10a2 2 0 012 2v17M3 22h14M7 22v-4h6v4M14 8h3a2 2 0 012 2v3M21 13v6"/><circle cx="20" cy="10" r="1"/></svg> Fuel Costs</h3>
    ...
    <script>
        function toggleMenu() {{
            ...
            document.body.style.overflow = document.getElementById('nav').classList.contains('active') ? 'hidden' : '';
        }}
    </script>
</body>
</html>'''
