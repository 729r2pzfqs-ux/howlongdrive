...
routes = []
for f in ['data/routes.json', 'data/routes_expanded.json', 'data/routes_commute.json', 'data/routes_tourist.json', 'data/routes_airport.json', 'data/routes_small_cities.json', 'data/routes_major.json', 'data/routes_destinations.json']:
    if os.path.exists(f):
