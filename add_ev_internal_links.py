...
# Build route map - which cities connect to which
...
for d in os.listdir('ev'):
    ...
    # Gas route link (keep existing)
    links_html += f'''<div class="related-group"><h4>Gas Route</h4><div class="related-links"><a href="/route/{from_slug}-to-{to_slug}/">View gas route: {from_city} to {to_city}</a></div></div>'''
...
print(f"✅ Added internal links to {count} EV pages")
